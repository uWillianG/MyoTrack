...
export default function ReviewBadge({ reviewStatus, reviewNote }: Props) {
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 px-2.5 py-0.5 text-xs font-medium">
